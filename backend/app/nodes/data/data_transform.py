...
class FilterNode(BaseNode):
    description = NodeDescription(
        ...
        category="Data",
        icon="filter",
        description="Keep only items where a field matches a condition such as equals, contains, greater than, or less than",
        color="#0ea5e9",
        inputs=["main"],
        outputs=["main"],
        properties=[
...
class SortNode(BaseNode):
    description = NodeDescription(
        ...
        category="Data",
        icon="filter",
        description="Sort incoming items by a field in ascending or descending order",
        color="#0ea5e9",
        inputs=["main"],
        outputs=["main"],
        properties=[
...
class LimitNode(BaseNode):
    description = NodeDescription(
        ...
        category="Data",
        icon="filter",
        description="Restrict the number of items passed on to a configurable maximum",
        color="#0ea5e9",
        inputs=["main"],
        outputs=["main"],
...
class AggregateNode(BaseNode):
    description = NodeDescription(
        ...
        category="Data",
        icon="filter",
        description="Compute a sum, average, min, max, or count over a field across all incoming items",
        color="#0ea5e9",
        inputs=["main"],
        outputs=["main"],
        properties=[
...
class RemoveDuplicatesNode(BaseNode):
    description = NodeDescription(
        ...
        category="Data",
        icon="filter",
        description="Remove duplicate items based on a field value or the full item content",
        color="#0ea5e9",
        inputs=["main"],
        outputs=["main"],
