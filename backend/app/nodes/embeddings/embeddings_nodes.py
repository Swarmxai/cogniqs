...
class OpenAIEmbeddingsNode(BaseNode):
    description = NodeDescription(
        ...
        icon="openai",
        color="#10a37f",
        description="OpenAI embeddings sub-node for turning text into searchable vectors.",
        inputs=[],
...
class OllamaEmbeddingsNode(BaseNode):
    description = NodeDescription(
        ...
        icon="ollama",
        color="#0ea5e9",
        description="Local Ollama embeddings sub-node for offline vectorization.",
        inputs=[],
        outputs=["ai_embeddings"],
        is_ai_subnode=True,
        ai_output_type="ai_embeddings",
...
class AzureOpenAIEmbeddingsNode(BaseNode):
    description = NodeDescription(
        ...
        icon="azure",
        color="#0078d4",
        description="Azure OpenAI embeddings sub-node for vectorizing text in RAG pipelines.",
        inputs=[],
        outputs=["ai_embeddings"],
        is_ai_subnode=True,
        ai_output_type="ai_embeddings",
